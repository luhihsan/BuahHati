...
public final class ActivitySignUpBinding implements ViewBinding {
  ...
  private ActivitySignUpBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRegister,
      @NonNull MyEditText edRegisterEmail, @NonNull TextInputEditText edRegisterName,
      @NonNull MyEditText edRegisterPassword, @NonNull TextInputLayout emailEditTextLayout,
  ...
  public static ActivitySignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignUpBinding((ConstraintLayout) rootView, btnRegister, edRegisterEmail,
          edRegisterName, edRegisterPassword, emailEditTextLayout, guideline2, guidelineHorizontal,
          main, nameEditTextLayout, passwordEditTextLayout, progressBar, tvEmail, tvName,
          tvPassword, tvTitle);
    }
